...
Note that you need your own account credentials, which is left empty in the code

# Files
## FYP M Fit + Full
Fits LC and CBD models on the 1961-2000 training window and produces the full 19-year forecast (Section 4.1 - 4.2)

# FYP M Rolling
Rolling Backtest for 1-, 3- and 5-year horizons (Section 4.3)

# FYP M Sensitivity
Sensitivity Analysis with alternative training windows and age ranges (Chapter 5)
